...
#    print(result)
    with open('./outputFiles/file.txt', 'w') as file:
        file.write(result)
    print(result)
    return result


def loadAndSplitDocs():
  
    loader = DirectoryLoader('/home/xgrid/workspace/openAi/hello', glob="**/*.tf", use_multithreading=True)
    docs = loader.load()
